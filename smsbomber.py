...
class Ui_titele(object):
    def setupUi(self, titele):
        titele.setObjectName("titele")
        titele.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        titele.resize(278, 190)
        titele.setUnifiedTitleAndToolBarOnMac(False)
        self.centralwidget = QtWidgets.QWidget(parent=titele)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.centralwidget)
        self.verticalLayoutWidget.setEnabled(True)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(50, 60, 186, 62))
        self.invalid = QtGui.QIntValidator()
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferDefault)
        self.verticalLayoutWidget.setFont(font)
        self.verticalLayoutWidget.setTabletTracking(False)
        ...
        self.Shomare = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget)
        self.Shomare.setEnabled(True)
        self.Shomare.setValidator(self.invalid)
        font = QtGui.QFont()
        ...
        font.setWeight(75)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferDefault)
        self.Shomare.setFont(font)
        self.Shomare.setTabletTracking(False)
        self.Shomare.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.Shomare.setAutoFillBackground(False)
        self.Shomare.setInputMethodHints(QtCore.Qt.InputMethodHint.ImhPreferNumbers)
        self.Shomare.setInputMask("")
        self.Shomare.setText("")
        self.Shomare.setMaxLength(11)
        self.Shomare.setFrame(True)
        self.Shomare.setEchoMode(QtWidgets.QLineEdit.EchoMode.Normal)
        self.Shomare.setCursorPosition(0)
        self.Shomare.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.Shomare.setDragEnabled(False)
        self.Shomare.setReadOnly(False)
        self.Shomare.setCursorMoveStyle(QtCore.Qt.CursorMoveStyle.LogicalMoveStyle)
        self.Shomare.setObjectName("Shomare")
        self.verticalLayout.addWidget(self.Shomare)
        ...
        self.pushButton.clicked.connect((self.dokme))
        self.verticalLayout_2.addWidget(self.pushButton)
        self.verticalLayout.addLayout(self.verticalLayout_2)
        titele.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=titele)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 278, 21))
        self.menubar.setObjectName("menubar")
        titele.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=titele)
        self.statusbar.setObjectName("statusbar")
        titele.setStatusBar(self.statusbar)

        self.retranslateUi(titele)
        QtCore.QMetaObject.connectSlotsByName(titele)
    def retranslateUi(self, titele):
        _translate = QtCore.QCoreApplication.translate
        titele.setWindowTitle(_translate("titele", "smSBomber"))
        self.Shomare.setPlaceholderText(_translate("titele", "شماره را وارد کنید"))
        self.pushButton.setText(_translate("titele", "Enter"))

    def dokme(self):
        mobil = self.Shomare.text()
        def snap(phone):
